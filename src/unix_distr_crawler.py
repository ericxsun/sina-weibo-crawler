...
from host.fetcher import HostFetcher
...
class Frame(wx.Frame):
    def __init__(self, title, status, host_fetcher):
        wx.Frame.__init__(self, parent=None, id=-1, title=title, size=(560, 500),
...
class Window(wx.App):
    def __init__(self, host_fetcher):
        ...
        self.frame = Frame(WIN_TITLE, WIN_STATUS, host_fetcher)
...
if __name__ == '__main__':
    username = ''
    password = ''
    host_fetcher = HostFetcher(username, password)
